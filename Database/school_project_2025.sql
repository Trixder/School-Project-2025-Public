...
--
-- Počítač: localhost
-- Vytvořeno: Pát 21. úno 2025, 10:55
...
('video', 'Co znamená slovo “dyk” ve větě “Dyk jaký má šaty!”', '[\"dýka\", \"díky\", \"mužský pohlavní orgán\", \"koukej\"]', 1, 3, 'slovnik', 'https://www.youtube.com/embed/Vc2XG2Uwt9w'),
('video', 'Co znamená slovo “valit” ve větě “Co borec valí?”', '[\"balit holku\", \"mluvit nesmysly\", \"balit cigaretu\", \"koulet předmět\"]', 2, 1, 'slovnik', 'https://www.youtube.com/embed/XxWbqB4OW7o'),
('video', 'Co znamená slovo “more” ve větě “more tak to je crazy”', '[\"více\", \"nechápu\", \"kámo\", \"moře bez ř\"]', 3, 2, 'slovnik', 'https://www.youtube.com/embed/asqvH57QA5M'),
('video', 'Co znamená pojem “hell nah” ve větě “Hell nah, to si deláš srandu.”', '[\"vůbec ne\", \"nebesky ne\", \"možná\", \"blázen\"]', 4, 0, 'slovnik\r\n', 'https://www.youtube.com/embed/_AWh6T41yF4'),
('video', 'Co znamená pojem “goated” ve větě “To je mega goated hra.”', '[\"primitivní jako zvíře\", \"špatný\", \"nepovedená\", \"nejlepší ze všech\"]', 5, 3, 'slovnik', 'https://www.youtube.com/embed/C4x2dfum9L0'),
('video', 'Co znamená pojem “on god” ve větě “Ta kalba byla mega fajn!” “On god!”', '[\"souhlasím\", \"ano\", \"doslova\", \"na slovo boží\"]', 6, 2, 'slovnik', 'https://www.youtube.com/embed/JChJC_e0Y8A'),
('video', 'Co znamená slovo “ara” ve větě “Ara, policie!”', '[\"bacha\", \"nečum\", \"papoušek\", \"utíkej!\"]', 7, 0, 'slovnik', 'https://www.youtube.com/embed/CAW-ENSK-aY'),
('video', 'Jaký význam má pojem “ghostnout” ve větě “Borec mě totálně vyghostil.”', '[\"vyděsit někoho\", \"ignorovat někoho\", \"dokouřit rychle cigaretu\", \"zapálit oblečení\"]', 8, 1, 'slovnik', 'https://www.youtube.com/embed/9KHgoZYAeWg'),
('video', 'Co znamená slovo “čára” ve větě “Dáme čáru?”', '[\"lajna\", \"panák\", \"šňupací tabák\", \"dřevotříska\"]', 9, 0, 'slovnik', 'https://www.youtube.com/embed/45S3Td-FEGo'),
('video', 'Jaký význam má pojem “lock in” ve větě “Já jsem se locknul in”', '[\"uzavřít se do sebe\", \"zamknout\", \"přestat myslet\", \"pořádně se soustředit\"]', 10, 3, 'slovnik', 'https://www.youtube.com/embed/W5Hd_7S_PPo'),
('video', 'Jaký význam má pojem “netflix and chill” ve větě “dáme netflix and chill?”', '[\"povídání o filmech\", \"filmový večer\", \"film a po něm pohlavní styk\", \"promítání na dobrou věc\"]', 11, 2, 'slovnik', 'https://www.youtube.com/embed/1zWjIm9c2hU'),
('video', 'Co znamená slovo “houska” ve větě “Pořádám housku v pátek.”', '[\"párty, kde hraje housová muzika\", \"akce u někoho doma\", \"pečivo\"]', 12, 1, 'slovnik', 'https://www.youtube.com/embed/xh9xg0RLm_Y'),
('video', 'Co znamená slovo “rave” ve větě “Jdeme na rave?”', '[\"diskotéka\", \"závody\", \"drink\", \"párty\"]', 13, 0, 'slovnik', 'https://www.youtube.com/embed/60AK8JhH9YQ'),
('video', 'Co znamená slovo “felit” ve větě “Je čas felit.”', '[\"uspokojovat se\", \"kouřit cigarety s přáteli\", \"jít ven\", \"přemýšlet\"]', 14, 3, 'slovnik', 'https://www.youtube.com/embed/vXNhEqcZZUQ'),
('video', 'Co znamená slovo “kár” ve větě “Ty seš fakt kár!”', '[\"vůl\", \"mužský pohlavní orgán\", \"kámoš\", \"holkolap\"]', 15, 1, 'slovnik', 'https://www.youtube.com/embed/yrh9qJgRies'),
...
('video', 'Zná kolemjdoucí význam slova?', '[\"Ano\",\"Ne\"]', 98, 0, 'kultura', 'https://www.youtube.com/embed/Bd4jBKMCoiE'),
('video', 'Zná kolemjdoucí význam slova?', '[\"Ano\",\"Ne\"]', 99, 1, 'kultura', 'https://www.youtube.com/embed/Nf6wvmLLu_s'),
('video', 'Zná kolemjdoucí význam slova?', '[\"Ano\",\"Ne\"]', 100, 1, 'kultura', 'https://www.youtube.com/embed/QoqMIhg-S6Q'),
('video', 'Zná kolemjdoucí význam slova?', '[\"Ano\",\"Ne\"]', 101, 0, 'kultura', 'https://www.youtube.com/embed/7Sl_kV8EboI'),
('video', 'Zná kolemjdoucí význam slova?', '[\"Ano\",\"Ne\"]', 102, 1, 'kultura', 'https://www.youtube.com/embed/ZLyZJBlSYUw'),
('video', 'Zná kolemjdoucí význam slova?', '[\"Ano\",\"Ne\"]', 103, 0, 'kultura', 'https://www.youtube.com/embed/wT70PVaBx6k');
